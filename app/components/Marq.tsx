...
const Marq = () => {
  return (
    <div className=" w-full max-w-screen z-40 mx-auto flex flex-col items-center justify-center overflow-hidden mb-[70px] lg:mb-[140px]">
      <h1 className="text-center mb-[40px] text-[#e48673] [font-family:--font-monadi] text-[12px] lg:text-xl font-normal leading-7 opacity-80">
        تقديم الدكتور أحمد الدملاوي مؤسس هذه الدورات
      </h1>
      <div className="relative w-full">
        <Marquee
          pauseOnHover={true}
          gradient={true}
          gradientColor="#f4edeb"
          speed={50}
        >
